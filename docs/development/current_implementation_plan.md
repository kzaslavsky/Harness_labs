...
| `<user-home>/.codex/skills/implement-v11/SKILL.md`, `serial-implement/SKILL.md` | Current Codex-compatible durable checkpoints, planning/review/implementation/verification phases and serial queue behavior | Package as portable Codex skill sources, with paths and package metadata made project-neutral. |
