#!/usr/bin/env python3
"""Convergence campaign harness PlanGraph runner (CC-01 … CC-05, CC-07).
...
def _launch_node(
    ...
    binding = PlanGraphFeatureRunBinding(
        ...
        source_binding_report={
            "claims": [
                ...
                f"resolution is recorded in {PLAN_PATH}."
            ]
        },
        build_briefing={
    ...
    def profile_builder(candidate: Path, evidence: EvidenceCatalog):
        ...
        return build_role_profiles(
            mixture={"convergence_implementer": IMPLEMENTER_SPEC},
