...
class PlanGraphAudit:
    ...
    def repair_contract_digest(
        *, plan: str, plan_sha256: str, base_commit: str, nodes: Mapping[str, Mapping[str, object]],
        ...
        if not isinstance(plan_sha256, str) or not plan_sha256:
            raise ValueError("durable PlanGraph requires a registration-verified plan hash")
        return _plan_graph_digest(plan=plan, plan_digest=plan_sha256, base_commit=base_commit,
