...
class FeatureRunTests(unittest.TestCase):
    ...
    def test_plan_graph_child_returns_allocation_bound_canonical_seal_receipt(
        ...
        self.assertEqual(
            ...
            ["engineering-plan", "source-binding-report", "build-briefing", "plan-graph-child-descriptor"],
        )
